  ...
  return (
    ...
    >
      <div className="grid min-h-dvh w-full max-w-[21rem] place-items-center">
        ...
        >
          <motion.p
            className="text-center text-body-sm font-black uppercase tracking-[0.16em] text-[#123f5a]"
          ...
          <div className="mt-2 grid w-full grid-cols-2 gap-2.5">
            {services.map((service, index) => (
              <motion.div
                key={service}
                className="rounded-2xl border border-[#e3edf1] bg-[#fbfdfc] px-3 py-2 text-center text-caption font-black uppercase tracking-[0.08em] text-[#123f5a] shadow-[0_8px_24px_rgba(18,63,90,0.05)]"
